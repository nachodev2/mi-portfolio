...
const AboutMe = () => {
  return (
    // 1. QUITAMOS overflow-hidden y aumentamos el padding vertical para que no se corte nada
    <section id="about" className="w-full bg-[#121212] py-32 relative">
      
      {/* 2. ESTRATEGIA DE ALINEACIÓN:
          - Eliminamos 'max-w-7xl mx-auto'.
          - Usamos 'w-full' para ocupar toda la pantalla.
          - 'px-8 md:px-20 lg:px-32': Padding lateral grande para empujar el contenido hacia adentro pero manteniéndolo alineado con los bordes visuales del Hero.
          - 'gap-20 lg:gap-40': Un espacio GIGANTE entre columnas para separar el texto de los servicios.
      */}
      <div className="w-full px-6 md:px-20 lg:px-40 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-40 items-start">
        
        {/* --- COLUMNA IZQUIERDA: SERVICIOS (Alineado a la Izquierda) --- */}
          ...
          <div className="grid grid-cols-3 gap-8 mt-10 border-t border-white/10 pt-10">
            ...
            <div className="flex flex-col">
              <span className="text-5xl font-bold text-white flex items-center gap-1">
                120 <span className="text-[#FFB703] text-3xl">+</span>
              </span>
              <span className="text-gray-500 text-sm mt-3 uppercase tracking-wider font-semibold">Completed Projects</span>
            </div>

            <div className="flex flex-col">
              <span className="text-5xl font-bold text-white flex items-center gap-1">
                95 <span className="text-[#FFB703] text-3xl">%</span>
              </span>
              <span className="text-gray-500 text-sm mt-3 uppercase tracking-wider font-semibold">Client Satisfaction</span>
            </div>
            ...
            <div className="flex flex-col">
              ...
              <span className="text-gray-500 text-sm mt-3 uppercase tracking-wider font-semibold">Years of Experience</span>
            </div>
